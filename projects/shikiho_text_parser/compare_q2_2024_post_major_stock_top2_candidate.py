...
OUT_DIR = ROOT / "projects" / "shikiho_text_parser" / "output" / "compare_q2_2024_post_major_stock_top2_candidate"
...
def run_backtest() -> dict:
    ...
    for date in dates:
        ...
        for ticker in price_map:
            ...
            if post_major_active:
                ...
                if last_entry is not None and (date - last_entry).days <= COOLDOWN:
                    continue
                basis_idx = df.index[df.index < date]
        ...
        post_major_candidates = [c for c in candidates if c[3] == "post_major_trend"][:TOP_N]
    ...
    return {
        "variant": "q2_2024_post_major_stock_break0p2_top2_cool0",
        "dataset": "q2_2024",
