...
OUT_DIR = ROOT / "projects" / "shikiho_text_parser" / "output" / "compare_alloc50_post_major_price_concentration_candidate"
...
def main() -> int:
    ...
    for name, spec in specs.items():
        ...
        out_dir.mkdir(parents=True, exist_ok=True)
        payload = {
            "variant": "alloc50_post_major_price_concentration_2516_or_stock_prev_high_break_top2_tp6_sl3",
            "dataset": name,
            "concentrated_mode": f"ETF {ETF_TICKER} prev_high_break tp6/sl3 with sector+price concentration",
            "dispersed_mode": f"stock prev_high_break top{STOCK_TOP_N} tp6/sl3 after sector+price dispersion",
