...
OUT_DIR = ROOT / "projects" / "shikiho_text_parser" / "output" / "post_crash_switch_search_v2"
...
def main() -> int:
    ...
    specs = [
        DatasetSpec("q2_2024", ROOT / "projects" / "quarterly_ranker" / "output" / "q2_2024_pre_analysis_20240630_aligned" / "q2_2024_pre_shikiho_feature_ranking.csv", "2024-07-01", "2024-09-30"),
