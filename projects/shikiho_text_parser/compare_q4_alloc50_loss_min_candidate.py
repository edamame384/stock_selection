...
OUT_DIR = ROOT / "projects" / "shikiho_text_parser" / "output" / "q4_alloc50_loss_min_candidate"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Compare q4 alloc50 loss-min candidates.")
