...
BACKTEST = ROOT / "projects" / "shikiho_text_parser" / "backtest_phase_adaptive_practical_v35_uptrend_interval_candidate.py"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run practical phase-adaptive v3.5 candidate with a separate uptrend rebuild interval.")
    ...
    parser.add_argument("--uptrend-rebuild-interval-trading-days", type=int, required=True)
