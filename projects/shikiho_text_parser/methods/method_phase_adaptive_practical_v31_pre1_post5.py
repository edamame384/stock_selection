...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run named method: phase_adaptive_practical_v3.1_pre1_post5")
    ...
    cmd = [
        sys.executable,
        str(ROOT / "projects" / "shikiho_text_parser" / "backtest_phase_adaptive_practical_v31_pre1_post5.py"),
        "--earnings-pre-days",
        "1",
        "--earnings-post-days",
        "5",
