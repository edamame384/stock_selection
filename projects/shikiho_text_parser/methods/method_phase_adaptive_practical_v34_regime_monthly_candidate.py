...
BACKTEST = ROOT / "projects" / "shikiho_text_parser" / "backtest_phase_adaptive_practical_v34_regime_monthly_candidate.py"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run v3.4 regime-linked monthly rebuild candidate.")
