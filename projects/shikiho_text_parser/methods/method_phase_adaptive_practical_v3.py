...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run named method: phase_adaptive_practical_v3")
    ...
    cmd = [
        sys.executable,
        str(ROOT / "projects" / "shikiho_text_parser" / "backtest_phase_adaptive_practical_v3.py"),
        "--detail-csv",
        str(args.detail_csv),
        "--selected-csv",
