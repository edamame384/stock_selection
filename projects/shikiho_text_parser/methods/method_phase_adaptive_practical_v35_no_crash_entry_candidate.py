...
BACKTEST = ROOT / "projects" / "shikiho_text_parser" / "backtest_phase_adaptive_practical_v35_no_crash_entry_candidate.py"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run practical phase-adaptive v3.5 candidate with crash entries disabled.")
