...
REGENERATED_CSV = ROOT / "projects" / "shikiho_text_parser" / "output" / "q2_2024_theme_section_regenerated" / "q2_2024_theme_section_regenerated.csv"
OUT_DIR = ROOT / "projects" / "shikiho_text_parser" / "output" / "q2_2024_theme_section_regenerated_compare"
...
def main() -> int:
    ...
    merged = detail_df.merge(regen_df[["ticker", "best_variant", "theme_text_regenerated"]], on="ticker", how="inner")
    merged["section_groups"] = merged["theme_text_regenerated"].map(detect_theme_groups)
    ...
    for theme, g in exploded.groupby("section_groups"):
        ...
        g[["ticker", "company_name", "sector", "best_variant", "theme_text_regenerated"]].to_csv(
